...
function renderDocuments(){
 ...
 const visibleRows=fpListRows("documents",rows);
 const hint=$("#documentRegisterHint");if(hint)hint.textContent=`Показано ${visibleRows.length} из ${rows.length} · сначала документы, требующие внимания.`;
 ...
 fpAppendListMore(root,"documents",rows.length,renderDocuments);
